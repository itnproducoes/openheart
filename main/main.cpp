/*  Open Heart by 32mbit
    ...
    Region switching: press reset for 3 seconds to
    ...
    In-game reset pico: Hold A+C+Start for 3 seconds
    
    In-game logo 16bit or Sega or Sonic Logo: Hold Start+C

    No control active module bluethooh suport va0 in va4

    Turn on the console by pressing the UP button to turn the Bluetooth module ON of OFF. The last ON or OFF selection will be persistent in new boot.
  
    In-game B+start for 2 second active bluethooh module

    Overclocking: Hold A+Start for 1 second to toggle between
    MCLK/7 (7.67MHz, standard) and MCLK/5 (10.74MHz va5/6 or 8MHz va0 to va4).
...
#define GPIO_RST_TFT 1          // To pin RST display ST7735S
#define GPIO_CS_TFT 2           // To pin CS display ST7735S or pin SDA display SSD1306
#define GPIO_DC_TFT 3           // To pin DC display ST7735S or pin SCL display SSD1306
#define GPIO_UP_PIN 4           // Wired to controller port 1 pin 1
#define GPIO_M3_PIN 5           // master system mode detect
#define GPIO_SCLK_TFT 6         // To pin SCKL/SCL display ST7735S
#define GPIO_SDIN_TFT 7         // To pin SD display ST7735S
...
#define GPIO_DETECT_DISPLAY 26  // To pin detect display ST7735
#define GPIO_BLUE_PIN 27        // To pin bluethooh
