...
In accordance with best practices for open‑source compliance, this notice documents the **origin, authors, licenses**, and **the period** during which such files were accessible.
...
They were not used in the build process and were present only due to historical oversight.

## 2. General Notice

The presence of GPL‑licensed components in older commits does not modify the license of the rest of the OpenHeart project.
Each third‑party component retains its original license, regardless of license changes in the OpenHeart project.
Removal of these files on January 17, 2026 prevents future ambiguity but does not revoke rights previously granted (especially concerning GPL‑3.0 material).


## 3. Contact
For questions about this notice or licensing compliance:
